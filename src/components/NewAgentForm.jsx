                    ...
                    <form className='  w-full  bg-white p-10 rounded-xl text-left'>
                        <div>
                            ...
                            <div className='my-4'>
                                ...
                                <input type="text" placeholder="Company" className=' bg-transparent w-full rounded-xl outline-none border-1 border-gray-300 text-sm text-black py-1 px-3 focus:border-orange-600 h-10' value={company} onChange={(e) => setCompany(e.target.value)} />
                                {err === true && phone === '' ? <span className='text-red-600'>company Required</span> : null}
                            </div>
                            <div className='my-4'>
